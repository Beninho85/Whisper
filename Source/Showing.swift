...
public func show(whisper attrMessage: AttributedMessage, to: UINavigationController, action: WhisperAction = .show) {
    whisperFactory.craft(attrMessage, navigationController: to, action: action)
}
